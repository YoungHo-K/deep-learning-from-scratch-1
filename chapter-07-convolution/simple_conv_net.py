...
class SimpleConvNet:
    ...
    def accuracy(self, x, t, batch_size=100):
        ...
        acc = 0.0
        for index in range(0, int(x.shape[0] / batch_size)):
            tx = x[index * batch_size: (index + 1) * batch_size]
            tt = t[index * batch_size: (index + 1) * batch_size]
    ...
    def save_params(self, file_name="params.pkl"):
        ...
        with open(file_name, 'wb') as file_descriptor:
            pickle.dump(params, file_descriptor)

    def load_params(self, file_name="params.pkl"):
        with open(file_name, 'rb') as file_descriptor:
            params = pickle.load(file_descriptor)
